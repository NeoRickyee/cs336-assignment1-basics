...
def run_multihead_self_attention(
    ...
    """
    Attention = attention.MultiHeadSelfAttention(d_model, num_heads)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    Attention = attention.MultiHeadSelfAttention(d_model, num_heads, True, theta, max_seq_len)
    Attention.load_state_dict({
        "wq.weight" : q_proj_weight,
        "wk.weight" : k_proj_weight,
        "wv.weight" : v_proj_weight,
...
from cs336_basics import adamw_optimizer

def get_adamw_cls() -> Any:
    """
    Returns a torch.optim.Optimizer that implements AdamW.
    """
    return adamw_optimizer.AdamW
...
def get_tokenizer(
    ...
    """
    Tokenizer = tokenizer.Tokenizer(vocab, merges, special_tokens)
    return Tokenizer
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    BPE = bpe.BPE(input_path, vocab_size, special_tokens)
    return BPE.train()
